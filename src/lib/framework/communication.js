    ...
    return new Promise((resolve, reject) => {
        if (obj && obj.userId) {
            Db.models.notification
                .findAll({ where: { contactid: obj.contactId, read: false } })
                .then((result) => {
            ...
            util.handleError(new Error("commGetAllActiveNotificationforUser failed.  obj or obj.contactid does not exist.")).then(() => {
                reject(new Error("commGetAllActiveNotificationforUser failed.  obj or obj.contactid does not exist."));
            });
        }
    });
};
...
Communication.prototype.commGetAllActiveNotificationsforUserByType = function (obj) {
    return new Promise((resolve, reject) => {
        if (obj && obj.contactId && obj.notificationtypeId) {
            Db.models.notification
                .findAll({ where: { contactid: obj.contactId, notificationtypeid: obj.notificationtypeId, read: false } })
                .then((result) => {
                    resolve(JSON.parse(JSON.stringify(result)));
                })
                .catch((err) => {
            ...
            util.handleError(
                new Error("commGetAllActiveNotificationsforUserByType failed.  obj or obj.contactId or obj.communicationTypeId does not exist."),
            ).then(() => {
                reject(
                    new Error("commGetAllActiveNotificationsforUserByType failed.  obj or obj.contactId or obj.communicationTypeId does not exist."),
                );
...
Communication.prototype.commGetAllActiveNotificationsByType = function () {
    return new Promise((resolve, reject) => {
        Db.models.communication
            .findAll({ where: { notificationtypeid: id, enabled: false } })
            .then((result) => {
                resolve(JSON.parse(JSON.stringify(result)));
            })
            .catch((err) => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj && obj.Id) {
                ...
                util.handleError(new Error("commGetNotificationById failed.  obj or obj.Id does not exist.")).then(() => {
                    reject(new Error("commGetNotificationById failed.  obj does not exist."));
                });
            }
        } catch (e) {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj && obj.id) {
                ...
                util.handleError(new Error("getNotificationTypeById failed.  obj or obj.id does not exist.")).then(() => {
                    reject(new Error("getNotificationTypeById failed.  obj or obj.id does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
...
Communication.prototype.commGetAllActiveCommsforUser = function (obj) {
    return new Promise((resolve, reject) => {
        if (obj && obj.userId) {
            Db.models.communicationlog
                .findAll({ where: { contactid: obj.contactId, enabled: true } })
                .then((result) => {
                    resolve(JSON.parse(JSON.stringify(result)));
                })
                .catch((err) => {
            ...
            util.handleError(new Error("commGetAllActiveCommsforUser failed.  obj or obj.userId does not exist.")).then(() => {
                reject(new Error("commGetAllActiveCommsforUser failed.  obj or obj.userId does not exist."));
            });
        }
    });
};
...
Communication.prototype.commGetAllActiveCommsforUserByType = function (obj) {
    return new Promise((resolve, reject) => {
        if (obj && obj.userId && obj.communicationTypeId) {
            Db.models.communication
                .findAll({ where: { userid: obj.userId, communicationtypeid: obj.communicationTypeId } })
                .then((result) => {
                    resolve(JSON.parse(JSON.stringify(result)));
                })
                .catch((err) => {
            ...
            util.handleError(new Error("commGetAllActiveCommsforUser failed.  obj or obj.userId or obj.communicationTypeId does not exist.")).then(
                () => {
                    reject(new Error("commGetAllActiveCommsforUser failed.  obj or obj.userId or obj.communicationTypeId does not exist."));
                },
            );
        }
    });
...
Communication.prototype.commGetAllActiveCommsByType = function () {
    return new Promise((resolve, reject) => {
        Db.models.communication
            .findAll({ where: { communicationtypeid: communicationTypeId, enabled: true } })
            .then((result) => {
                resolve(JSON.parse(JSON.stringify(result)));
            })
            .catch((err) => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj && obj.communicationId) {
                ...
                util.handleError(new Error("commGetCommById failed.  obj does not exist.")).then(() => {
                    reject(new Error("commGetCommById failed.  obj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj && obj.communicationTypeId) {
                ...
                util.handleError(new Error("getCommunicationTypeById failed.  obj or obj.communicationId does not exist.")).then(() => {
                    reject(new Error("getCommunicationTypeById failed.  obj or obj.communicationId does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
...
Communication.prototype.setCommunicationLogRecord = function (obj) {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj) {
                objInternal.prepObject(obj).then((newObj) => {
                    if (newObj.id) {
                        resolve(Db.models.communicationlog.update(newObj, { where: { id: newObj.id } }));
                    } else {
                ...
                util.handleError(new Error("setCommunicationLogRecord failed.  obj does not exist.")).then(() => {
                    reject(new Error("setCommunicationLogRecord failed.  obj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj) {
                ...
                util.handleError(new Error("setCommNotificationRecord failed.  obj does not exist.")).then(() => {
                    reject(new Error("setCommNotificationRecord failed.  obj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj) {
                ...
                util.handleError(new Error("createCommunicationType failed.  obj does not exist.")).then(() => {
                    reject(new Error("createCommunicationType failed.  obj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
            ...
            if (communicationObj) {
                if (communicationObj.communicationTypeId) {
                    if (communicationObj.communicationTypeId == settings.communication().communicationTypeIdSMS) {
                        objInternal
                            .sendSMSCommunication(communicationObj)
                            .then((smsMessageId) => {
                                resolve(smsMessageId);
                            })
                            .catch((e) => {
                                util.handleError(new Error("Update to schedule update count failed. " + e.message)).then(() => {
                                    reject(new Error("Update to schedule update count failed. " + e.message));
                                });
                            });
                    } else if (communicationObj.communicationTypeId == settings.communication().communicationTypeIdEmail) {
                        objInternal
                            .sendEmailCommunication(
                                communicationObj.from,
                                communicationObj.toEmail,
                                communicationObj.subject,
                                communicationObj.content,
                            )
                            .then((smsMessageId) => {
                                resolve(smsMessageId);
                            })
                        ...
                        objInternal
                            .sendWebDesktopNotification(communication.messageType, communicationObj.to, communicationObj.content)
                            .then((notificationId) => {
                        ...
                        objInternal
                            .sendMobileCommunication(communicationObj.to, communicationObj.content)
                            .then((notificationId) => {
                                resolve(notificationId);
                            })
                            .catch((e) => {
                    ...
                    util.handleError(new Error("Communication Type Id is required" + validation.message)).then(() => {
                        reject(new Error("SMS Communication is invalid" + validation.message));
                    });
                }
            } else {
                util.handleError(new Error("commSendComm failed.  communicationObj does not exist.")).then(() => {
                    reject(new Error("commSendComm failed.  communicationObj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
...
Communication.prototype.commValidateComm = function (communicationObj) {
    return new Promise((resolve, reject) => {
        try {
            ...
            util.handleError(new error("Failed to validate schedule")).then(() => {
                reject(new error("Failed to validate schedule"));
            });
        }
    });
};
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj) {
                ...
                util.handleError(new Error("commSetNotificationType failed.  obj does not exist.")).then(() => {
                    reject(new Error("commSetNotificationType failed.  obj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
...
Communication.prototype.commSendEmailCommunication = function (communicationObj) {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (communicationObj) {
                objInternal.validateCommunication(communicationObj).then((validation) => {
                    if (validation.isValid) {
                        var dtTemp = moment(new Date());
                        objContent = {
                            communicationTypeId: settings.communication().communicationTypeIdEmail,
                            from: communicationObj.from,
                            to: communicationObj.to,
                            subject: communicationObj.subject,
                            body: communicationObj.body,
                            attachmentPath: communicationObj.attachmentPath,
                        };
                        mail.send(from, to, subject, body, attachmentPath).then((sentMessageId) => {
                            //log Email sent
                            objInternal
                        ...
                        util.handleError(new Error("SMS Communication is invalid" + validation.message)).then(() => {
                            reject(new Error("SMS Communication is invalid" + validation.message));
                        });
                    }
                });
            } else {
                util.handleError(new Error("commSendEmailCommunication failed.  communicationObj does not exist.")).then(() => {
                    reject(new Error("commSendEmailCommunication failed.  communicationObj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
            ...
            if (communicationObj) {
                objInternal.validateCommunication(communicationObj).then((validation) => {
                    if (validation.isValid) {
                        ...
                        sms.sendSMS(toNumber, content).then((sentMessageId) => {
                            //log SMS sent
                            objInternal
                                .createCommunicationLogRecord({
                                    communicationtypeid: settings.communication().communicationTypeIdSMS,
                                    content: JSON.stringify(objContent),
                                    issueddate: dtTemp,
                                })
                                .then((sentMessageId) => {
                ...
                util.handleError(new Error("sendSMSCommunication failed.  communicationObj does not exist.")).then(() => {
                    reject(new Error("sendSMSCommunication failed.  communicationObj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
            ...
            if (communicationObj) {
                objInternal.validateCommunication(communicationObj).then((validation) => {
                    if (validation.isValid) {
                        ...
                        var dtTemp = moment(new Date());
                        objContent = {
                            communicationTypeId: settings.communication().communicationTypeIdMobile,
                            content: communicationObj.content,
                            token: communicationObj.token,
                        };
                        ...
                        util.handleError(new Error("Mobile Communication is invalid" + validation.message)).then(() => {
                            reject(new Error("Mobile Communication is invalid" + validation.message));
                        });
                    }
                });
            } else {
                util.handleError(new Error("sendMobileCommunication failed.  communicationObj does not exist.")).then(() => {
                    reject(new Error("sendMobileCommunication failed.  communicationObj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
            ...
            if (communicationObj) {
                objInternal.validateCommunication(communicationObj).then((validation) => {
                    if (validation.isValid) {
                        ...
                        var dtTemp = moment(new Date());
                        objContent = {
                            communicationTypeId: settings.communication().communicationTypeIdWebDesktop,
                            messageType: communicationObj.messageType,
                            to: communicationObj.to,
                            content: communicationObj.content,
                        };

                        objInternal.socketEmit(objContent).then(() => {
                            //log Notification sent
                            objInternal
                                .createCommunicationLogRecord({
                                    communicationtypeid: settings.communication().communicationTypeIdWebDesktop,
                        ...
                        util.handleError(new Error("sendWebDesktopNotification failed.  communicationOjb is invalid" + validation.message)).then(
                            () => {
                                reject(new Error("sendWebDesktopNotification failed.  communicationOjb is invalid"));
                            },
                        );
                    }
                });
            } else {
                util.handleError(new Error("sendWebDesktopNotification failed.  communicationObj does not exist.")).then(() => {
                    reject(new Error("sendWebDesktopNotification failed.  communicationObj does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
    ...
    return new Promise((resolve, reject) => {
        try {
            if (obj && obj.id) {
                ...
                util.handleError(new Error("deleteCommunicationLog failed.  obj or obj.id does not exist.")).then(() => {
                    reject(new Error("deleteCommunicationLog failed.  obj or obj.id does not exist."));
                });
            }
        } catch (e) {
            util.handleError(e).then(() => {
...
Communication.prototype.prepObject = function (obj) {
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            util.handleError(new Error("Failed to prepare object for Communication.")).then(() => {
                reject(new Error("Failed to prepare object for Communication."));
            });
        }
    });
};
